...
imagesScopeKey=$(jq -r '.imagesScopeKey' "$configFile")
userPassword=$(jq -r '.userPassword' "$configFile")
assetLibraryPersonasFolderId=$(jq -r '.assetLibraryPersonasFolderId' "$configFile")
spacePersonasFolderId=$(jq -r '.spacePersonasFolderId' "$configFile")
